...
import com.coolappstore.everterminalplayer.data.lyrics.LyricLine
import com.coolappstore.everterminalplayer.data.lyrics.LyricWord
import com.coolappstore.everterminalplayer.data.lyrics.Lyrics
import com.coolappstore.everterminalplayer.data.lyrics.VOICE_GROUP
import com.coolappstore.everterminalplayer.data.lyrics.VOICE_SECONDARY
...
private fun singerColorFor(line: LyricLine, palette: List<Color>, fallback: Color): Color = when {
    line.interlude -> palette.first()
    line.singer < 0 -> fallback
...
private fun LyricLineRows(
    ...
    val singerColor = singerColorFor(line, palette, TuiBright)
