package com.coolappstore.everterminalplayer.player
...
suspend fun Context.mediaController(): MediaController = MediaController.Builder(
    this,
...
fun MediaController.queueLabels(): List<String> = (0 until mediaItemCount).map { i ->
...
fun String.codecLabel(): String = when {
