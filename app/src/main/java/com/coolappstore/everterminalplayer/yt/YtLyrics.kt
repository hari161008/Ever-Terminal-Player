 ...
 * [com.coolappstore.everterminalplayer.data.lyrics.LyricsParser] used for local files, so
...
object YtLyrics {
    ...
    private fun fetchFromLrcLib(title: String, artist: String): String? = runCatching {
        ...
        connection.setRequestProperty("User-Agent", "EverTerminalPlayer/1.0 (+https://github.com/hari161008/Ever-Terminal-Player)")
