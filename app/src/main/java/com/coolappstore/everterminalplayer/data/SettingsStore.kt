...
val KEY_FULLSCREEN = booleanPreferencesKey("full_screen")
...
val KEY_LAST_VIEW = stringPreferencesKey("last_view")
val KEY_LAST_ALBUM = stringPreferencesKey("last_album")
val KEY_LAST_FOLDER = stringPreferencesKey("last_folder")
val KEY_YT_PINNED = stringPreferencesKey("yt_pinned")
val KEY_LIGHT_MODE = booleanPreferencesKey("light_mode")
val KEY_SKIP_SILENCE = booleanPreferencesKey("skip_silence")
val KEY_KEEP_SCREEN_ON = booleanPreferencesKey("keep_screen_on")
val KEY_TELEGRAM_PROMPT_SHOWN = booleanPreferencesKey("telegram_prompt_shown")
